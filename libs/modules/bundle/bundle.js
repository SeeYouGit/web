...
/* harmony import */ var modules_dataModule_GameStaticData__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! modules/dataModule/GameStaticData */ "./src/modules/dataModule/GameStaticData.ts");
/* harmony import */ var modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! modules/dataModule/DinoModule */ "./src/modules/dataModule/DinoModule.ts");
    ...
    function Engine(stage) {
        ...
        _this.game = new xengine_game_Game__WEBPACK_IMPORTED_MODULE_4__["default"]({
            modules: [
                ...
                modules_dataModule_GameStaticData__WEBPACK_IMPORTED_MODULE_16__["default"],
                modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_17__["default"]
            ],
...
/* harmony import */ var _yunqu_Yunqu__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./yunqu/Yunqu */ "./src/modules/commerce/yunqu/Yunqu.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var CommerceModule = /** @class */ (function (_super) {
    ...
    function CommerceModule() {
        ...
        switch (config__WEBPACK_IMPORTED_MODULE_1__["default"].platform) {
            ...
            default:
                // this.register_provider(YunquProvider);
                pay_types[_payment__WEBPACK_IMPORTED_MODULE_2__["PayPoint"].DOUBLE_REWARD] = _payment__WEBPACK_IMPORTED_MODULE_2__["PayType"].REWARD_VIDEO;
                pay_types[_payment__WEBPACK_IMPORTED_MODULE_2__["PayPoint"].RELIVE] = _payment__WEBPACK_IMPORTED_MODULE_2__["PayType"].REWARD_VIDEO;
                pay_types[_payment__WEBPACK_IMPORTED_MODULE_2__["PayPoint"].TRY_BOOST_MODE] = _payment__WEBPACK_IMPORTED_MODULE_2__["PayType"].REWARD_VIDEO;
                break;
        ...
        return _this;
        // this.register_provider(ChongQingProvider);
    }
    ...
    Object.defineProperty(CommerceModule.prototype, "provider", {
        ...
        get: function () {
            switch (config__WEBPACK_IMPORTED_MODULE_1__["default"].platform) {
                ...
                case config__WEBPACK_IMPORTED_MODULE_1__["PlatformValue"].WECHAT:
                default:
                    return this.get_provider(_yunqu_Yunqu__WEBPACK_IMPORTED_MODULE_5__["default"]);
                    break;
            }
            return null;
        },
...
/***/ "./src/modules/dataModule/DinoModule.ts":
/*!**********************************************!*\
  !*** ./src/modules/dataModule/DinoModule.ts ***!
  \**********************************************/
/*! exports provided: RunnerConfig, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RunnerConfig", function() { return RunnerConfig; });
/* harmony import */ var xengine_game_Module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! xengine/game/Module */ "./src/xengine/game/Module.ts");
/* harmony import */ var xengine_game_Game__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! xengine/game/Game */ "./src/xengine/game/Game.ts");
...
var DinoModule = /** @class */ (function (_super) {
    __extends(DinoModule, _super);
    function DinoModule() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /** 初始化 */
    DinoModule.prototype.initialize = function () {
    ...
    /** 逻辑更新 */
    DinoModule.prototype.update = function (dt) { };
    /** 模块开始 */
    DinoModule.prototype.start = function () {
        // 初始化本关卡信息
    };
    /** 读档 */
    DinoModule.prototype.load = function (data) {
    };
    /** 存档 */
    DinoModule.prototype.save = function () { return undefined; };
    DinoModule = __decorate([
        Object(xengine_game_Module__WEBPACK_IMPORTED_MODULE_0__["game_module"])('DinoModule')
    ], DinoModule);
    return DinoModule;
}(xengine_game_Module__WEBPACK_IMPORTED_MODULE_0__["default"]));
/* harmony default export */ __webpack_exports__["default"] = (DinoModule);
...
var GameStaticData = /** @class */ (function (_super) {
    ...
    GameStaticData.prototype.on_config_loaded = function () {
        ...
        try {
            for (var _b = __values(this.Obstacle_data), _c = _b.next(); !_c.done; _c = _b.next()) {
                var lv = _c.value;
                this.Obstacles_data[lv.type] = lv;
            }
        }
        catch (e_1_1) { e_1 = { error: e_1_1 }; }
        finally {
    ...
    /** 获取关卡配置 */
    GameStaticData.prototype.get_obstacle_data = function (type) {
        return this.Obstacles_data[type];
    };
...
/***/ "./src/modules/func/RunnerMc.ts":
/*!**************************************!*\
  !*** ./src/modules/func/RunnerMc.ts ***!
  \**************************************/
/*! exports provided: RunnerMc */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RunnerMc", function() { return RunnerMc; });
/* harmony import */ var _mc__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mc */ "./src/modules/func/mc.ts");
/* harmony import */ var view_main_com_Runner__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! view/main/com/Runner */ "./src/view/main/com/Runner.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var RunnerMc = /** @class */ (function (_super) {
    __extends(RunnerMc, _super);
    function RunnerMc() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this._isGlass = false; //是不是镜像方向
        _this._dire = view_main_com_Runner__WEBPACK_IMPORTED_MODULE_1__["ERunType"].WAITING;
        return _this;
    }
    RunnerMc.prototype.getNowMovies = function () {
        throw new Error("Method not implemented.");
    }; //这个是死亡攻击站立
    RunnerMc.prototype.constructFromXML = function (xml) {
        _super.prototype.constructFromXML.call(this, xml);
        this._state = this.getController('c1');
    };
    RunnerMc.prototype.getNowMovie = function () {
        var mv = this.getChild(this._dire);
        if (mv instanceof fgui.GMovieClip) {
            return mv;
        }
        return null;
    };
    RunnerMc.prototype.stop = function () {
        var mv = this.getNowMovie();
        mv && (mv.playing = false);
    };
    RunnerMc.prototype.playBlink = function () {
        this.play(view_main_com_Runner__WEBPACK_IMPORTED_MODULE_1__["ERunType"].WAITING, true);
    };
    RunnerMc.prototype.play = function (lifeState, once, handler, dispose, dire) {
        if (lifeState === void 0) { lifeState = view_main_com_Runner__WEBPACK_IMPORTED_MODULE_1__["ERunType"].WAITING; }
        if (dispose === void 0) { dispose = true; }
        this.stop();
        this.updateState(lifeState);
        _super.prototype.play.call(this, lifeState, once, handler, dispose);
    };
    RunnerMc.prototype.updateState = function (lifeState) {
        this._state.selectedPage = lifeState;
    };
    Object.defineProperty(RunnerMc.prototype, "dire", {
        get: function () {
            return this._dire;
        },
        enumerable: true,
    ...
    Object.defineProperty(RunnerMc.prototype, "mc", {
        get: function () {
            return this._movies;
        },
        enumerable: true,
    ...
    return RunnerMc;
}(_mc__WEBPACK_IMPORTED_MODULE_0__["mc"]));



/***/ }),

/***/ "./src/modules/func/mc.ts":
/*!********************************!*\
  !*** ./src/modules/func/mc.ts ***!
  \********************************/
/*! exports provided: mc */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mc", function() { return mc; });
/* harmony import */ var view_main_com_Runner__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! view/main/com/Runner */ "./src/view/main/com/Runner.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var mc = /** @class */ (function (_super) {
    ...
    mc.prototype.constructFromXML = function (xml) {
        _super.prototype.constructFromXML.call(this, xml);
        this._movies = this._children;
        // this._movies.map((mv: fgui.GMovieClip) => {
        //     mv.setPivot(0.5, 0.5, true);
        //     mv.setXY(0, 0);
        // })
        // this.setXY(this.width / 2, this.height / 2);
        this.opaque = false;
    };
    Object.defineProperty(mc.prototype, "playing", {
        get: function () {
            var mv = this.getNowMovie();
            return mv.playing;
        },
    ...
    mc.prototype.play = function (lifeState, once, handler, dispose) {
        var _this = this;
        if (lifeState === void 0) { lifeState = view_main_com_Runner__WEBPACK_IMPORTED_MODULE_0__["ERunType"].WAITING; }
        if (dispose === void 0) { dispose = true; }
        var mv = this.getNowMovie();
        if (mv) {
            mv.playing = true;
            if (once) {
                mv.setPlaySettings(0, -1, 1, -1, Laya.Handler.create(this, function (endHandler) {
    ...
    Object.defineProperty(mc.prototype, "frame", {
        get: function () {
            var mv = this.getNowMovie();
            if (mv) {
                return mv.frame;
    ...
    Object.defineProperty(mc.prototype, "packName", {
        get: function () {
    ...
    Object.defineProperty(mc.prototype, "packItemName", {
        get: function () {
    ...
    Object.defineProperty(mc.prototype, "children", {
        get: function () {
...
/* harmony import */ var _main_MainScene__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./main/MainScene */ "./src/view/main/MainScene.ts");
/* harmony import */ var _raw_Main_UI_Main__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./raw/Main/UI_Main */ "./src/view/raw/Main/UI_Main.ts");
/* harmony import */ var _ToastView__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ToastView */ "./src/view/ToastView.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var FairyGUIBinder = /** @class */ (function (_super) {
    ...
    FairyGUIBinder.prototype.bind_views = function () {
        ...
        this.bind_view(_raw_Main_UI_Main__WEBPACK_IMPORTED_MODULE_7__["default"].URL, _main_MainScene__WEBPACK_IMPORTED_MODULE_6__["default"], true);
        // 注册 Toast 视图
        this.register_toast_view(_ToastView__WEBPACK_IMPORTED_MODULE_8__["default"]);
    };
...
/* harmony import */ var xengine_game_Game__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! xengine/game/Game */ "./src/xengine/game/Game.ts");
/* harmony import */ var modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! modules/dataModule/DinoModule */ "./src/modules/dataModule/DinoModule.ts");
/* harmony import */ var _com_Runner__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./com/Runner */ "./src/view/main/com/Runner.ts");
/* harmony import */ var _com_Horizon__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./com/Horizon */ "./src/view/main/com/Horizon.ts");
/* harmony import */ var _com_CollisionBox__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./com/CollisionBox */ "./src/view/main/com/CollisionBox.ts");
/* harmony import */ var _panel_gameOverView__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./panel/gameOverView */ "./src/view/main/panel/gameOverView.ts");
...
var MainScene = /** @class */ (function (_super) {
    ...
    function MainScene() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.speed = modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_2__["RunnerConfig"].SPEED;
        _this.distanceRan = 0;
        _this.playingIntro = false; // 是否正在执行开场动画动画
        _this.allPanels = [];
        _this.activated = false; // 按键或者开始游戏激活
        _this.started = false;
        _this.crashed = false; // 是否碰撞结束
        _this.FPS = 60;
        _this.msPerFrame = 1000 / _this.FPS;
        _this.time = 0;
        _this.runningTime = 0; // 总游戏进行时间
        _this.keycodes = {
            JUMP: { '38': 1, '32': 1 },
            DUCK: { '40': 1 },
            RESTART: { '13': 1 } // Enter
    ...
    MainScene.prototype.constructFromResource = function () {
        _super.prototype.constructFromResource.call(this);
        MainScene.inst = this;
        this.dinoModule = xengine_game_Game__WEBPACK_IMPORTED_MODULE_1__["default"].inst.get_module(modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_2__["default"]);
        ...
        this.m_startBtn.onClick(this, this.startRunGame);
        this._hero = new _com_Runner__WEBPACK_IMPORTED_MODULE_3__["default"]();
        this._horizon = new _com_Horizon__WEBPACK_IMPORTED_MODULE_4__["Horizons"]();
        Laya.stage.on(Laya.Event.KEY_DOWN, this, this.onKeyDown);
        Laya.stage.on(Laya.Event.KEY_UP, this, this.onKeyUp);
        Laya.stage.on(Laya.Event.MOUSE_DOWN, this, this.onKeyDown);
        Laya.stage.on(Laya.Event.MOUSE_UP, this, this.onKeyUp);
        // this.on(Laya.Event.DRAG_START, this, this.onKeyDown);
        // this.on(Laya.Event.DRAG_END, this, this.onKeyUp);
    };
    MainScene.prototype.startRunGame = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this.started)
                    return [2 /*return*/];
                this.play();
                Laya.timer.frameLoop(1, this, this.runGameUpdate);
                return [2 /*return*/];
            });
        });
    };
    MainScene.prototype.runGameUpdate = function () {
        var now = Laya.Browser.now();
        var deltaTime = now - (this.time || now);
        this.time = now;
        if (this.activated) {
            if (this._hero.jumping) {
                this._hero.updateJump(deltaTime);
            }
            this.runningTime += deltaTime;
            var hasObstacles = this.runningTime > modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_2__["RunnerConfig"].CLEAR_TIME;
            // First jump triggers the intro.
            if (this._hero.jumpCount == 0 && !this.playingIntro) {
                this.playIntro();
            }
            // The horizon doesn't move until the intro is over.
            if (this.playingIntro) {
                this._horizon.update(0, hasObstacles);
            }
            else {
                deltaTime = !this.started ? 0 : deltaTime;
                this._horizon.update(deltaTime, hasObstacles);
            }
            // Check for collisions.
            var collision = hasObstacles &&
                this.checkForCollision(this._horizon.obstacles[0], this._hero);
            if (!collision) {
                this.distanceRan += this.speed * deltaTime / this.msPerFrame;
                this.m_gradeTxt.text = Math.floor(this.distanceRan).toString();
                if (this.speed < modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_2__["RunnerConfig"].MAX_SPEED) {
                    this.speed += modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_2__["RunnerConfig"].ACCELERATION;
                }
            }
            else {
                this.gameOver();
        ...
        if (!this.crashed) {
            this._hero.updateState(deltaTime);
        }
    };
    MainScene.prototype.gameOver = function () {
        ...
        this._hero.updateState(100, _com_Runner__WEBPACK_IMPORTED_MODULE_3__["ERunType"].CRASHED);
        // show gameOverpanel
        this.showGameOverView(this._horizon.obstacles[0]);
        this.m_gradeTxt.text = Math.floor(this.distanceRan).toString();
        // Update the high score.
        if (this.distanceRan > this.dinoModule.highestScore) {
            this.dinoModule.highestScore = Math.ceil(this.distanceRan);
            // this.distanceMeter.setHighScore(this.highestScore);
        }
        // Reset the time clock.
        this.time = Laya.Browser.now();
    };
    MainScene.prototype.boxCompare = function (tRexBox, obstacleBox) {
        var crashed = false;
    ...
    MainScene.prototype.checkForCollision = function (obstacle, tRex, opt_canvasCtx) {
        if (opt_canvasCtx === void 0) { opt_canvasCtx = true; }
        var obstacleBoxXPos = Laya.stage.width + obstacle.x;
        // Adjustments are made to the bounding box as there is a 1 pixel white
        // border around the t-rex and obstacles.
        var tRexBox = new _com_CollisionBox__WEBPACK_IMPORTED_MODULE_5__["CollisionBox"](tRex.xPos + 1, tRex.yPos + 1, modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_2__["RunnerConfig"].WIDTH - 2, modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_2__["RunnerConfig"].HEIGHT - 2);
        var obstacleBox = new _com_CollisionBox__WEBPACK_IMPORTED_MODULE_5__["CollisionBox"](obstacle.x + 1, obstacle.y + 1, obstacle.data.width * obstacle.size - 2, obstacle.data.height - 2);
        if (this.boxCompare(tRexBox, obstacleBox)) {
            var collisionBoxes = obstacle.collisionBoxes;
            var tRexCollisionBoxes = tRex.ducking ?
                _com_Runner__WEBPACK_IMPORTED_MODULE_3__["runnerCollisionBoxes"].DUCKING : _com_Runner__WEBPACK_IMPORTED_MODULE_3__["runnerCollisionBoxes"].RUNNING;
            // Detailed axis aligned box check.
            for (var t = 0; t < tRexCollisionBoxes.length; t++) {
                for (var i = 0; i < collisionBoxes.length; i++) {
                    // Adjust the box to actual positions.
                    var adjTrexBox = this.createAdjustedCollisionBox(tRexCollisionBoxes[t], tRexBox);
                    var adjObstacleBox = this.createAdjustedCollisionBox(collisionBoxes[i], obstacleBox);
                    var crashed = this.boxCompare(adjTrexBox, adjObstacleBox);
                    if (crashed) {
    ...
    MainScene.prototype.createAdjustedCollisionBox = function (box, adjustment) {
        return new _com_CollisionBox__WEBPACK_IMPORTED_MODULE_5__["CollisionBox"](box.x + adjustment.x, box.y + adjustment.y, box.width, box.height);
    };
    MainScene.prototype.playIntro = function () {
    ...
    MainScene.prototype.startGame = function () {
        ...
        Laya.stage.on(Laya.Event.FOCUS, this, this.onVisibilityChange, [true]);
        Laya.stage.on(Laya.Event.BLUR, this, this.onVisibilityChange, [false]);
        // this.on(Laya.Event.VISIBILITY_CHANGE, this, this.onVisibilityChange, [true]);
    };
    MainScene.prototype.onVisibilityChange = function (bool) {
        if (!bool) {
            this.stop();
        }
        else if (!this.crashed) {
    ...
    MainScene.prototype.play = function () {
        if (!this.crashed) {
            this.activated = true;
            this._hero.updateState(0, _com_Runner__WEBPACK_IMPORTED_MODULE_3__["ERunType"].RUNNING);
            this.time = Laya.Browser.now();
            this.runGameUpdate();
        }
    };
    ...
    MainScene.prototype.onKeyUp = function (e) {
        ...
        var isjumpKey = this.keycodes.JUMP[keyCode] ||
            e.type == Laya.Event.MOUSE_DOWN;
        if (this.activated && isjumpKey) {
            this._hero.endJump();
        }
        else if (this.keycodes.DUCK[keyCode]) {
            this._hero.speedDrop = false;
            this._hero.setDuck(false);
        }
        else if (this.crashed) {
            // Check that enough time has elapsed before allowing jump key to restart.
            var deltaTime = Laya.Browser.now() - this.time;
            if (this.keycodes.RESTART[keyCode] ||
                (deltaTime >= modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_2__["RunnerConfig"].GAMEOVER_CLEAR_TIME &&
                    this.keycodes.JUMP[keyCode])) {
                this.restart();
            }
        }
        else if (!this.activated && isjumpKey) {
    ...
    MainScene.prototype.onKeyDown = function (e) {
        if (!this.started)
            return;
        if (!this.crashed && (this.keycodes.JUMP[e.keyCode] ||
            e.type == Laya.Event.MOUSE_DOWN)) {
            if (!this.activated) {
                // this.loadSounds();
                this.activated = true;
            ...
            if (!this._hero.jumping && !this._hero.ducking) {
                // this.playSound(this.soundFx.BUTTON_PRESS);
                this._hero.startJump();
            }
        }
        ...
        if (this.activated && !this.crashed && this.keycodes.DUCK[e.keyCode]) {
            ...
            if (this._hero.jumping) {
                ...
                this._hero.setSpeedDrop();
            }
            else if (!this._hero.jumping && !this._hero.ducking) {
                // Duck.
                this._hero.setDuck(true);
            }
        }
    };
    MainScene.prototype.restart = function () {
        ...
        this.crashed = false;
        this.distanceRan = 0;
        this.setSpeed(modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_2__["RunnerConfig"].SPEED);
        this.time = Laya.Browser.now();
    ...
    MainScene.prototype.setSpeed = function (opt_speed) {
        var speed = opt_speed || this.speed;
        // Reduce the speed on smaller mobile screens.
        if (Laya.stage.width < modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_2__["RunnerConfig"].DEFAULT_WIDTH) {
            var mobileSpeed = speed * Laya.stage.width / modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_2__["RunnerConfig"].DEFAULT_WIDTH *
                modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_2__["RunnerConfig"].MOBILE_SPEED_COEFFICIENT;
            this.speed = mobileSpeed > speed ? speed : mobileSpeed;
        }
        else if (opt_speed) {
            this.speed = opt_speed;
        }
    };
    MainScene.prototype.showGameOverView = function (obstacle) {
        this.gameOverView = this.gameOverView || this.createObj(view_raw_Main_UI_gameOverView__WEBPACK_IMPORTED_MODULE_7__["default"].URL, _panel_gameOverView__WEBPACK_IMPORTED_MODULE_6__["default"]);
        this.gameOverView.setData(obstacle);
        this.addChild(this.gameOverView);
        this.removeOtherPanel(this.gameOverView);
        return this.gameOverView;
    };
    // showGameFailView() {
    // 	this.gameFailView = this.gameFailView || this.createObj(UI_GameOverView.URL, GameOverView);
    // 	this.addChild(this.gameFailView);
    // 	this.removeOtherPanel(this.gameFailView);
    // 	return this.gameFailView;
    // }
    // showMainView() {
    // 	this.mianView = this.mianView || this.createObj(UI_MainView.URL, MianView);
...
/***/ "./src/view/main/com/CollisionBox.ts":
/*!*******************************************!*\
  !*** ./src/view/main/com/CollisionBox.ts ***!
  \*******************************************/
/*! exports provided: CollisionBox */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CollisionBox", function() { return CollisionBox; });
// 地平线
var CollisionBox = /** @class */ (function () {
    ...
    // 配置表的数据 0,0,0,0;1,1,1,1
    CollisionBox.cloneCollisionBoxes = function (config, scale) {
        if (scale === void 0) { scale = 1; }
        var temp = config.split(";");
        var boxes = [];
        temp.forEach(function (str, index) {
            var arr = str.split(",");
            boxes[index] = new CollisionBox(parseInt(arr[0]), parseInt(arr[1]), parseInt(arr[2]) * scale, parseInt(arr[3]) * scale);
        });
        return boxes;
    };
    return CollisionBox;
...
/***/ "./src/view/main/com/Horizon.ts":
/*!**************************************!*\
  !*** ./src/view/main/com/Horizon.ts ***!
  \**************************************/
/*! exports provided: Horizons */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Horizons", function() { return Horizons; });
/* harmony import */ var _MainScene__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../MainScene */ "./src/view/main/MainScene.ts");
/* harmony import */ var _Obstacle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Obstacle */ "./src/view/main/com/Obstacle.ts");
/* harmony import */ var xengine_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! xengine/utils */ "./src/xengine/utils/index.ts");
/* harmony import */ var modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! modules/dataModule/DinoModule */ "./src/modules/dataModule/DinoModule.ts");




// 地平线
var Horizons = /** @class */ (function () {
    function Horizons() {
        this.obstacles = [];
        this.xPos = [0, 0];
        ...
        this._hight = 12;
        this.yPos = 0;
        this._hroizon1 = new fgui.GLoader();
        this._hroizon2 = new fgui.GLoader();
        this._hroizon1.url = "assets/ui/plot/hroizon.jpg";
        this._hroizon2.url = "assets/ui/plot/hroizon.jpg";
        _MainScene__WEBPACK_IMPORTED_MODULE_0__["default"].inst.addChildAt(this._hroizon1, 0);
        _MainScene__WEBPACK_IMPORTED_MODULE_0__["default"].inst.addChildAt(this._hroizon2, 0);
    }
    /**
     * @param {number} deltaTime
     * @param {boolean} updateObstacles Used as an override to prevent
     */
    Horizons.prototype.update = function (deltaTime, updateObstacles) {
        // this.runningTime += deltaTime;
        this.updateHroizon(deltaTime);
        // this.updateClouds(deltaTime);
        if (updateObstacles) {
            this.updateObstacles(deltaTime);
        }
    };
    Horizons.prototype.updateHroizon = function (deltaTime) {
        var increment = _MainScene__WEBPACK_IMPORTED_MODULE_0__["default"].inst.speed * (_MainScene__WEBPACK_IMPORTED_MODULE_0__["default"].inst.FPS / 1000) * deltaTime;
        if (this.xPos[0] <= 0) {
            this.updateHroizonXpos(0, increment);
        }
        else {
            this.updateHroizonXpos(1, increment);
        }
    };
    Horizons.prototype.updateHroizonXpos = function (pos, increment) {
        var line1 = pos;
        var line2 = pos == 0 ? 1 : 0;
        this.xPos[line1] -= increment;
        this.xPos[line2] = this.xPos[line1] + this._width;
        if (this.xPos[line1] <= -this._width) {
            this.xPos[line1] += this._width * 2;
            this.xPos[line2] = this.xPos[line1] - this._width;
            // this.sourceXPos[line1] = this.getRandomType() + this.spritePos.x;
        }
        this._hroizon1.x = this.xPos[line1];
        this._hroizon2.x = this.xPos[line2];
        this._hroizon1.y = this._hroizon2.y = this.yPos;
    };
    /**
  * Update the obstacle positions.
  * @param {number} deltaTime
  */
    Horizons.prototype.updateObstacles = function (deltaTime) {
        ...
        if (this.obstacles.length > 0) {
            ...
            if (lastObstacle && !lastObstacle.followingObstacleCreated &&
                ...
                (lastObstacle.x + lastObstacle.width + lastObstacle.gap) < this._width) {
                this.addNewObstacle();
    ...
    Horizons.prototype.addNewObstacle = function () {
        var allType = _MainScene__WEBPACK_IMPORTED_MODULE_0__["default"].inst.dinoModule.staticData.Obstacle_data;
        var obstacleTypeIndex = Object(xengine_utils__WEBPACK_IMPORTED_MODULE_2__["getRandomIntNum"])(0, allType.length - 1);
        var obstacleType = allType[obstacleTypeIndex];
        // Check for multiples of the same type of obstacle.
        // Also check obstacle is available at current speed.
        if (this.duplicateObstacleCheck(obstacleType.type) ||
            _MainScene__WEBPACK_IMPORTED_MODULE_0__["default"].inst.speed < obstacleType.minSpeed) {
            this.addNewObstacle();
        }
        else {
            var obstacle = fgui.UIPackage.createObject("Main", "obstacleCom", _Obstacle__WEBPACK_IMPORTED_MODULE_1__["Obstacle"]);
            _MainScene__WEBPACK_IMPORTED_MODULE_0__["default"].inst.addChild(obstacle);
            this.obstacles.push(obstacle);
            obstacle.setData(obstacleType);
            // new Obstacle(obstacleType,
            //     obstacleSpritePos, this.dimensions,
            //     this.gapCoefficient, currentSpeed));
            this.obstacleHistory.unshift(obstacleType.type);
            if (this.obstacleHistory.length > 1) {
                this.obstacleHistory.splice(modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_3__["RunnerConfig"].MAX_OBSTACLE_DUPLICATION);
            }
        }
    };
    // 不能重复生成同一个
    Horizons.prototype.duplicateObstacleCheck = function (nextObstacleType) {
        var duplicateCount = 0;
        for (var i = 0; i < this.obstacleHistory.length; i++) {
            duplicateCount = this.obstacleHistory[i] == nextObstacleType ?
                duplicateCount + 1 : 0;
        }
        return duplicateCount >= modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_3__["RunnerConfig"].MAX_OBSTACLE_DUPLICATION;
    };
    Horizons.prototype.reset = function () {
        this.obstacles = [];
        this.xPos[0] = 0;
        this.xPos[1] = this._width;
    };
    return Horizons;
}());
...
/* harmony import */ var _MainScene__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../MainScene */ "./src/view/main/MainScene.ts");
/* harmony import */ var view_raw_Main_UI_obstacleCom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! view/raw/Main/UI_obstacleCom */ "./src/view/raw/Main/UI_obstacleCom.ts");
/* harmony import */ var xengine_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! xengine/utils */ "./src/xengine/utils/index.ts");
/* harmony import */ var _CollisionBox__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./CollisionBox */ "./src/view/main/com/CollisionBox.ts");
/* harmony import */ var modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! modules/dataModule/DinoModule */ "./src/modules/dataModule/DinoModule.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
(function (EObstacleType) {
    EObstacleType["CACTUS_SMALL"] = "CACTUS_SMALL";
    EObstacleType["CACTUS_LARGE"] = "CACTUS_LARGE";
    EObstacleType["PTERODACTYL"] = "PTERODACTYL";
})(EObstacleType || (EObstacleType = {}));
var Obstacle = /** @class */ (function (_super) {
    ...
    function Obstacle() {
        ...
        _this.size = 1;
        _this.gap = 0;
        _this.followingObstacleCreated = false;
        _this.remove = false;
        _this.sizeMaxM = 1; //最大的 变大数  暂时不支持
        _this.speedOffset = 0; // 有运动的碰撞体
        _this.scale = 0.6;
        _this.MAX_GAP_COEFFICIENT = 1.5; //最大的间隙数  产生一个随机值
        return _this;
    }
    Obstacle.prototype.constructFromResource = function () {
        _super.prototype.constructFromResource.call(this);
    };
    Obstacle.prototype.setData = function (data) {
        this.setScale(this.scale, this.scale);
        this.m_c1.selectedPage = data.type;
        this.data = data;
        this.size = Object(xengine_utils__WEBPACK_IMPORTED_MODULE_2__["getRandomIntNum"])(1, this.sizeMaxM);
        this.collisionBoxes = _CollisionBox__WEBPACK_IMPORTED_MODULE_3__["CollisionBox"].cloneCollisionBoxes(this.data.collisionBoxes, this.scale);
        this.drawCollisionBoxes();
        var speed = _MainScene__WEBPACK_IMPORTED_MODULE_0__["default"].inst.speed;
        // Only allow sizing if we're at the right speed.
        if (this.size > 1 && this.data.multipleSpeed > speed) {
            this.size = 1;
        }
        // this.width = this.typeConfig.width * this.size;
        this.x = modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_4__["RunnerConfig"].DEFAULT_WIDTH + this.width;
        // Check if obstacle can be positioned at various heights.
        var tempY;
        if (Array.isArray(this.data.yPos)) {
            // var yPosConfig = IS_MOBILE ? this.typeConfig.yPosMobile :
            //     this.typeConfig.yPos;
            tempY = this.data.yPos[Object(xengine_utils__WEBPACK_IMPORTED_MODULE_2__["getRandomIntNum"])(0, this.data.yPos.length - 1)];
        }
        else {
            tempY = this.data.yPos;
        }
        // 暂时加 123的值
        this.y = modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_4__["RunnerConfig"].DEFAULT_HEIGH / 2 + 100; // - tempY - this.height / 2 ;
        if (this.size > 1) {
        ...
        if (this.data.speedOffset) {
            this.speedOffset = Math.random() > 0.5 ? this.data.speedOffset :
                -this.data.speedOffset;
        }
        this.gap = this.getGap(modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_4__["RunnerConfig"].GAP_COEFFICIENT, speed);
    };
    Obstacle.prototype.drawCollisionBoxes = function () {
        var _this = this;
        this.collisionBoxes.forEach(function (coll) {
            var sp = new Laya.Sprite();
            _this.displayObject.addChild(sp);
            sp.graphics.drawRect(coll.x, coll.y, coll.width / _this.scale, coll.height / _this.scale, "#f00", "#0f0", 3);
        });
    };
    /**
    ...
    Obstacle.prototype.update = function (deltaTime) {
        ...
        if (!this.remove) {
            ...
            this.x -= (speed * _MainScene__WEBPACK_IMPORTED_MODULE_0__["default"].inst.FPS / 1000) * deltaTime;
            if (!this.isVisible()) {
                if (!this._displayObject.destroyed) {
                    this.dispose();
                }
                this.remove = true;
            }
    ...
    Obstacle.prototype.getGap = function (gapCoefficient, speed) {
        var minGap = Math.round(this.data.width * speed +
            this.data.minGap * gapCoefficient);
        var maxGap = Math.round(minGap * this.MAX_GAP_COEFFICIENT);
        return Object(xengine_utils__WEBPACK_IMPORTED_MODULE_2__["getRandomIntNum"])(minGap, maxGap);
    };
    Obstacle.prototype.isVisible = function () {
        return this.x + this.width > 0;
    };
    return Obstacle;
}(view_raw_Main_UI_obstacleCom__WEBPACK_IMPORTED_MODULE_1__["default"]));
...
/***/ "./src/view/main/com/Runner.ts":
/*!*************************************!*\
  !*** ./src/view/main/com/Runner.ts ***!
  \*************************************/
/*! exports provided: ERunType, runnerCollisionBoxes, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ERunType", function() { return ERunType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "runnerCollisionBoxes", function() { return runnerCollisionBoxes; });
/* harmony import */ var modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! modules/dataModule/DinoModule */ "./src/modules/dataModule/DinoModule.ts");
/* harmony import */ var modules_func_RunnerMc__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! modules/func/RunnerMc */ "./src/modules/func/RunnerMc.ts");
/* harmony import */ var _MainScene__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../MainScene */ "./src/view/main/MainScene.ts");
/* harmony import */ var _CollisionBox__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./CollisionBox */ "./src/view/main/com/CollisionBox.ts");
...
var ERunType;
(function (ERunType) {
    ERunType["CRASHED"] = "CRASHED";
    ERunType["DUCKING"] = "DUCKING";
    ERunType["JUMPING"] = "JUMPING";
    ERunType["RUNNING"] = "RUNNING";
    ERunType["WAITING"] = "WAITING";
})(ERunType || (ERunType = {}));
var runnerCollisionBoxes = {
    DUCKING: [
        new _CollisionBox__WEBPACK_IMPORTED_MODULE_3__["CollisionBox"](1, 18, 55, 25)
    ],
    RUNNING: [
        new _CollisionBox__WEBPACK_IMPORTED_MODULE_3__["CollisionBox"](80, 80, 150, 150),
    ]
};
var Runner = /** @class */ (function () {
    function Runner() {
        this._xPos = 0;
        this._yPos = 0;
        this.status = ERunType.WAITING; // 当前的状态
        this.groundYPos = 0; // 人物在地面上时的 y 坐标
        this.currentFrame = 0; // 当前的动画帧
        this.currentAnimFrames = []; // 存储当前状态的动画帧 x 坐标
        this.animStartTime = 0; // 人物眨眼动画开始时间
    ...
    Runner.prototype.setData = function () {
    };
    Runner.prototype.updateDrawSprite = function () {
        var _this = this;
        this.runnerSprite = fgui.UIPackage.createObject("Main", "hero", modules_func_RunnerMc__WEBPACK_IMPORTED_MODULE_1__["RunnerMc"]);
        _MainScene__WEBPACK_IMPORTED_MODULE_2__["default"].inst.addChild(this.runnerSprite);
        var temp = runnerCollisionBoxes.RUNNING;
        temp.forEach(function (box) {
            var sp = new Laya.Sprite();
            _this.runnerSprite.displayObject.addChild(sp);
            sp.graphics.drawRect(box.x, box.y, box.width, box.height, "#f00", "#0f0", 3);
        });
        // MovieClip.getMcByType(this.skinName, Laya.Handler.create(this, (mc: RunnerMc) => {
        //     this.runnerSprite = mc;
        // }), RunnerMc);
    };
    Runner.prototype.updateState = function (deltaTime, opt_status) {
        if (opt_status === void 0) { opt_status = null; }
        ...
        if (opt_status && opt_status != this.status) {
            ...
            this.currentFrame = 0;
            // 播放动画
            this.runnerSprite.updateState(opt_status);
            if (opt_status == ERunType.WAITING) {
                this.animStartTime = this.getTimeStamp();
                this.setBlinkDelay();
            }
            // else {
            //     this.runnerSprite.play(opt_status)
            // }
        }
        if (_MainScene__WEBPACK_IMPORTED_MODULE_2__["default"].inst.playingIntro && this.xPos < modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_0__["RunnerConfig"].START_X_POS) {
            this.xPos += Math.round((modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_0__["RunnerConfig"].START_X_POS /
                modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_0__["RunnerConfig"].INTRO_DURATION) * deltaTime);
        }
        if (this.status == ERunType.WAITING) {
    ...
    Runner.prototype.init = function () {
        ...
        this.setBlinkDelay();
        this.groundYPos = modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_0__["RunnerConfig"].DEFAULT_HEIGH / 2; // - RunnerConfig.HEIGHT / 2;
        this.yPos = this.groundYPos;
        this.minJumpHeight = this.groundYPos - modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_0__["RunnerConfig"].MIN_JUMP_HEIGHT;
        this.updateState(0, ERunType.WAITING);
    };
    Object.defineProperty(Runner.prototype, "xPos", {
        get: function () {
            return this._xPos;
        },
        set: function (x) {
            this._xPos = x;
            this.runnerSprite.x = x;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Runner.prototype, "yPos", {
        get: function () {
            return this._yPos;
        },
        set: function (y) {
            this._yPos = y;
            this.runnerSprite.y = y;
        },
        enumerable: true,
        configurable: true
    });
    // 开始延时眨眼
    Runner.prototype.blink = function (time) {
        var deltaTime = time - this.animStartTime;
        if (deltaTime >= this.blinkDelay) {
            this.runnerSprite.playBlink();
            this.setBlinkDelay();
            this.animStartTime = time;
        }
    };
    Runner.prototype.setBlinkDelay = function () {
        this.blinkDelay = Math.ceil(Math.random() * modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_0__["RunnerConfig"].BLINK_TIMING);
    };
    Runner.prototype.getTimeStamp = function () {
        return Date.now();
 ...
 */
    Runner.prototype.setDuck = function (isDucking) {
        if (isDucking && this.status != ERunType.DUCKING) {
            this.updateState(0, ERunType.DUCKING);
            this.ducking = true;
        }
        else if (this.status == ERunType.DUCKING) {
            this.updateState(0, ERunType.RUNNING);
            this.ducking = false;
        }
    };
    /**
    ...
    * @param {number} speed
    */
    Runner.prototype.updateJump = function (deltaTime) {
        var msPerFrame = this.animFrames[this.status].msPerFrame;
        var framesElapsed = deltaTime / msPerFrame;
        // Speed drop makes Trex fall faster.
        if (this.speedDrop) {
            this.yPos += Math.round(this.jumpVelocity *
                modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_0__["RunnerConfig"].SPEED_DROP_COEFFICIENT * framesElapsed);
        }
        else {
            this.yPos += Math.round(this.jumpVelocity * framesElapsed);
        }
        this.jumpVelocity += modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_0__["RunnerConfig"].GRAVITY * framesElapsed;
        // Minimum height has been reached.
        if (this.yPos < this.minJumpHeight || this.speedDrop) {
            this.reachedMinHeight = true;
        }
        // Reached max height
        if (this.yPos < modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_0__["RunnerConfig"].MAX_JUMP_HEIGHT || this.speedDrop) {
            this.endJump();
        }
    ...
    Runner.prototype.startJump = function () {
        if (!this.jumping) {
            this.updateState(0, ERunType.JUMPING);
            // Tweak the jump velocity based on the speed.
            this.jumpVelocity = modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_0__["RunnerConfig"].INITIAL_JUMP_VELOCITY - (_MainScene__WEBPACK_IMPORTED_MODULE_2__["default"].inst.speed / 10);
            this.jumping = true;
    ...
    // 设置下落
    Runner.prototype.setSpeedDrop = function () {
        this.speedDrop = true;
        this.jumpVelocity = 1;
    };
    Runner.prototype.endJump = function () {
        if (this.reachedMinHeight &&
            this.jumpVelocity < modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_0__["RunnerConfig"].DROP_VELOCITY) {
            this.jumpVelocity = modules_dataModule_DinoModule__WEBPACK_IMPORTED_MODULE_0__["RunnerConfig"].DROP_VELOCITY;
        }
    };
...
/***/ "./src/view/main/panel/gameOverView.ts":
/*!*********************************************!*\
  !*** ./src/view/main/panel/gameOverView.ts ***!
  \*********************************************/
/*! exports provided: default */
...
var GameOverView = /** @class */ (function (_super) {
    ...
    GameOverView.prototype.setData = function (obstacle) {
        this.m_desc.text = obstacle.data.desc;
    };
    return GameOverView;
...
/* harmony import */ var _UI_obstacleCom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./UI_obstacleCom */ "./src/view/raw/Main/UI_obstacleCom.ts");
/* harmony import */ var _UI_hero__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./UI_hero */ "./src/view/raw/Main/UI_hero.ts");
/* harmony import */ var _UI_Main__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./UI_Main */ "./src/view/raw/Main/UI_Main.ts");
/** This is an automatically generated class by FairyGUI. Please do not modify it. **/
...
var MainBinder = /** @class */ (function () {
    ...
    MainBinder.bindAll = function () {
        fgui.UIObjectFactory.setExtension(_UI_gameOverView__WEBPACK_IMPORTED_MODULE_0__["default"].URL, _UI_gameOverView__WEBPACK_IMPORTED_MODULE_0__["default"]);
        fgui.UIObjectFactory.setExtension(_UI_obstacleCom__WEBPACK_IMPORTED_MODULE_1__["default"].URL, _UI_obstacleCom__WEBPACK_IMPORTED_MODULE_1__["default"]);
        fgui.UIObjectFactory.setExtension(_UI_hero__WEBPACK_IMPORTED_MODULE_2__["default"].URL, _UI_hero__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
var UI_Main = /** @class */ (function (_super) {
    ...
    UI_Main.prototype.onConstruct = function () {
        this.m_bg1 = (this.getChild("bg1"));
        this.m_bg2 = (this.getChild("bg2"));
        this.m_startBtn = (this.getChild("startBtn"));
        this.m_gradeTxt = (this.getChild("gradeTxt"));
...
var UI_gameOverView = /** @class */ (function (_super) {
    ...
    UI_gameOverView.createInstance = function () {
        return (fgui.UIPackage.createObject("Main", "gameOverView"));
    };
    UI_gameOverView.prototype.onConstruct = function () {
        this.m_gameOver = (this.getChild("gameOver"));
        this.m_desc = (this.getChild("desc"));
    };
    UI_gameOverView.URL = "ui://dyaqtnkv9br4z5g";
...
var UI_hero = /** @class */ (function (_super) {
    __extends(UI_hero, _super);
    function UI_hero() {
        return _super.call(this) || this;
    }
    UI_hero.createInstance = function () {
        return (fgui.UIPackage.createObject("Main", "hero"));
    };
    UI_hero.prototype.onConstruct = function () {
        this.m_c1 = this.getController("c1");
        this.m_CRASHED = (this.getChild("CRASHED"));
        this.m_WAITING = (this.getChild("WAITING"));
        this.m_RUNNING = (this.getChild("RUNNING"));
        this.m_JUMPING = (this.getChild("JUMPING"));
    };
    UI_hero.URL = "ui://dyaqtnkvparuz5e";
    return UI_hero;
}(fgui.GComponent));
/* harmony default export */ __webpack_exports__["default"] = (UI_hero);


/***/ }),

/***/ "./src/view/raw/Main/UI_obstacleCom.ts":
/*!*********************************************!*\
  !*** ./src/view/raw/Main/UI_obstacleCom.ts ***!
  \*********************************************/
/*! exports provided: default */
...
var UI_obstacleCom = /** @class */ (function (_super) {
    __extends(UI_obstacleCom, _super);
    function UI_obstacleCom() {
        return _super.call(this) || this;
    }
    UI_obstacleCom.createInstance = function () {
        return (fgui.UIPackage.createObject("Main", "obstacleCom"));
    };
    UI_obstacleCom.prototype.onConstruct = function () {
        this.m_c1 = this.getController("c1");
        this.m_eMeng = (this.getChild("eMeng"));
    };
    UI_obstacleCom.URL = "ui://dyaqtnkvf6nyz4u";
    return UI_obstacleCom;
}(fgui.GComponent));
/* harmony default export */ __webpack_exports__["default"] = (UI_obstacleCom);
...
var SplashScene = /** @class */ (function (_super) {
    ...
    SplashScene.prototype.onReady = function () {
        ...
        this.m_progress.tweenValue(45, 1);
        // 加载第一关卡
        ...
        xengine_game_Game__WEBPACK_IMPORTED_MODULE_3__["default"].inst.on(xengine_game_Game__WEBPACK_IMPORTED_MODULE_3__["ELoadPro"].RESLOADSUC, this, function () {
            _this.m_progress.value = 100;
            console.log("开始游戏");
            xengine_XEngine__WEBPACK_IMPORTED_MODULE_2__["default"].inst.scene_manager.replace("Main");
        });
    };
    SplashScene.prototype.loadMain = function () {
        this.m_progress.tweenValue(95, 2);
        xengine_XEngine__WEBPACK_IMPORTED_MODULE_2__["default"].inst.scene_manager.push('Main', true);
    };
    return SplashScene;
...
/*!**********************************!*\
  !*** ./src/xengine/game/Game.ts ***!
  \**********************************/
/*! exports provided: Events, LoadingState, ELoadPro, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ELoadPro", function() { return ELoadPro; });
/* harmony import */ var xengine_events_EventDispatcher__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! xengine/events/EventDispatcher */ "./src/xengine/events/EventDispatcher.ts");
...
var ELoadPro;
(function (ELoadPro) {
    ELoadPro["RESLOADSUC"] = "resLoadSuc";
})(ELoadPro || (ELoadPro = {}));
...
/*!************************************!*\
  !*** ./src/xengine/utils/index.ts ***!
  \************************************/
/*! exports provided: array_erase, shuffle_array, findChild, clamp, random_range, getRandomIntNum, format_time_duration */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRandomIntNum", function() { return getRandomIntNum; });
 ...
 * @param name 需要查找的节点名
 */
function findChild(sp, name) {
    if (sp.name == name)
        return sp;
    else
        return _findChild(sp._children, name);
}
function _findChild(spArr, name) {
    var arr = [];
...
var SceneManager = /** @class */ (function (_super) {
     ...
     */
    SceneManager.prototype.push = function (scene_name, nowSwitchScene) {
        if (nowSwitchScene === void 0) { nowSwitchScene = true; }
        return __awaiter(this, void 0, void 0, function () {
            var scene, current;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (!nowSwitchScene) return [3 /*break*/, 5];
