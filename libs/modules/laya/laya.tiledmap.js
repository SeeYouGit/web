...
(function (exports, Laya) {
    ...
    var GridSprite = function (_Laya$Sprite) {
        _inherits(GridSprite, _Laya$Sprite);

        function GridSprite() {
            _classCallCheck(this, GridSprite);

            var _this = _possibleConstructorReturn(this, (GridSprite.__proto__ || Object.getPrototypeOf(GridSprite)).apply(this, arguments));
    ...
    var TileAniSprite = function (_Laya$Sprite2) {
        _inherits(TileAniSprite, _Laya$Sprite2);

        function TileAniSprite() {
            _classCallCheck(this, TileAniSprite);

            var _this2 = _possibleConstructorReturn(this, (TileAniSprite.__proto__ || Object.getPrototypeOf(TileAniSprite)).apply(this, arguments));
    ...
    var MapLayer = function (_Laya$Sprite3) {
        _inherits(MapLayer, _Laya$Sprite3);

        function MapLayer() {
            _classCallCheck(this, MapLayer);

            var _this3 = _possibleConstructorReturn(this, (MapLayer.__proto__ || Object.getPrototypeOf(MapLayer)).apply(this, arguments));
    ...
    var TileMapAniData = function TileMapAniData() {
