...
(function (exports, Laya) {
    ...
    var AnimationPlayer = function (_Laya$EventDispatcher) {
        _inherits(AnimationPlayer, _Laya$EventDispatcher);

        function AnimationPlayer() {
            _classCallCheck(this, AnimationPlayer);

            var _this = _possibleConstructorReturn(this, (AnimationPlayer.__proto__ || Object.getPrototypeOf(AnimationPlayer)).call(this));
    ...
    var AnimationTemplet = function (_Laya$Resource) {
        _inherits(AnimationTemplet, _Laya$Resource);

        function AnimationTemplet() {
            _classCallCheck(this, AnimationTemplet);

            var _this2 = _possibleConstructorReturn(this, (AnimationTemplet.__proto__ || Object.getPrototypeOf(AnimationTemplet)).call(this));
    ...
    var GraphicsAni = function (_Laya$Graphics) {
        _inherits(GraphicsAni, _Laya$Graphics);

        function GraphicsAni() {
            _classCallCheck(this, GraphicsAni);

            return _possibleConstructorReturn(this, (GraphicsAni.__proto__ || Object.getPrototypeOf(GraphicsAni)).apply(this, arguments));
        }
    ...
    var SkinMeshForGraphic = function (_MeshData) {
        _inherits(SkinMeshForGraphic, _MeshData);

        function SkinMeshForGraphic() {
            _classCallCheck(this, SkinMeshForGraphic);

            return _possibleConstructorReturn(this, (SkinMeshForGraphic.__proto__ || Object.getPrototypeOf(SkinMeshForGraphic)).call(this));
        }
    ...
    var Skeleton = function (_Laya$Sprite) {
        ...
        function Skeleton() {
            ...
            var _this5 = _possibleConstructorReturn(this, (Skeleton.__proto__ || Object.getPrototypeOf(Skeleton)).call(this));

            _this5._boneMatrixArray = [];
            _this5._lastTime = 0;
            _this5._currAniIndex = -1;
            _this5._pause = true;
            _this5._aniClipIndex = -1;
            _this5._clipIndex = -1;
            _this5._skinIndex = 0;
            _this5._skinName = "default";
            _this5._aniMode = 0;
            _this5._index = -1;
            _this5._total = -1;
            _this5._indexControl = false;
            _this5._eventIndex = 0;
            _this5._drawOrderIndex = 0;
            _this5._drawOrder = null;
            _this5._lastAniClipIndex = -1;
            _this5._lastUpdateAniClipIndex = -1;
            _this5._playAudio = true;
            _this5._soundChannelArr = [];
            if (templet) _this5.init(templet, aniMode);
            return _this5;
        }
        ...
        _createClass(Skeleton, [{
            ...
            value: function destroy() {
                ...
                _get(Skeleton.prototype.__proto__ || Object.getPrototypeOf(Skeleton.prototype), "destroy", this).call(this, destroyChild);
    ...
    var Templet = function (_AnimationTemplet) {
        _inherits(Templet, _AnimationTemplet);

        function Templet() {
            _classCallCheck(this, Templet);

            var _this6 = _possibleConstructorReturn(this, (Templet.__proto__ || Object.getPrototypeOf(Templet)).apply(this, arguments));

            _this6._graphicsCache = [];
            _this6.srcBoneMatrixArr = [];
            _this6.ikArr = [];
            _this6.tfArr = [];
            _this6.pathArr = [];
            _this6.boneSlotDic = {};
            _this6.bindBoneBoneSlotDic = {};
            _this6.boneSlotArray = [];
            _this6.skinDataArray = [];
            _this6.skinDic = {};
            _this6.subTextureDic = {};
            _this6.isParseFail = false;
            _this6.drawOrderAniArr = [];
            _this6.eventAniArr = [];
            _this6.attachmentNames = null;
            _this6.deformAniArr = [];
            _this6.skinSlotDisplayDataArr = [];
            _this6._isParseAudio = false;
            _this6._isDestroyed = false;
            _this6._rate = 30;
            _this6.isParserComplete = false;
            _this6.aniSectionDic = {};
            _this6._textureDic = {};
            _this6.mBoneArr = [];
            return _this6;
        }
        ...
        _createClass(Templet, [{
            ...
            key: "parse",
            value: function parse(data) {
                _get(Templet.prototype.__proto__ || Object.getPrototypeOf(Templet.prototype), "parse", this).call(this, data);
            ...
            value: function _setCreateURL(url) {
                ...
                _get(Templet.prototype.__proto__ || Object.getPrototypeOf(Templet.prototype), "_setCreateURL", this).call(this, url);
            }
        }, {
            ...
            value: function destroy() {
                ...
                _get(Templet.prototype.__proto__ || Object.getPrototypeOf(Templet.prototype), "destroy", this).call(this);
    ...
    var MovieClip = function (_Laya$Sprite2) {
        ...
        function MovieClip() {
            ...
            var _this7 = _possibleConstructorReturn(this, (MovieClip.__proto__ || Object.getPrototypeOf(MovieClip)).call(this));
            ...
            _this7._idOfSprite = [];
            _this7._reset();
            _this7._playing = false;
            _this7._parentMovieClip = parentMovieClip;
            if (!parentMovieClip) {
                _this7._movieClipList = [_this7];
                _this7._isRoot = true;
                _this7._setBitUp(Laya.Const.DISPLAY);
            } else {
                _this7._isRoot = false;
                _this7._movieClipList = parentMovieClip._movieClipList;
                _this7._movieClipList.push(_this7);
            }
            return _this7;
        }
        ...
        _createClass(MovieClip, [{
            ...
            value: function destroy() {
                ...
                this._clear();
                _get(MovieClip.prototype.__proto__ || Object.getPrototypeOf(MovieClip.prototype), "destroy", this).call(this, destroyChild);
            }
        }, {
            key: "_setDisplay",
            value: function _setDisplay(value) {
                _get(MovieClip.prototype.__proto__ || Object.getPrototypeOf(MovieClip.prototype), "_setDisplay", this).call(this, value);
                if (this._isRoot) {
